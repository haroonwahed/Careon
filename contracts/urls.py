...
urlpatterns = [
    ...
    path('api/notifications/<int:notification_id>/read/', api_views.notifications_mark_read_api, name='notifications_mark_read_api'),
    path('api/notifications/mark-all-read/', api_views.notifications_mark_all_read_api, name='notifications_mark_all_read_api'),

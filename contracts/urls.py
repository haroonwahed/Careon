...
urlpatterns = [
    ...
    path('api/cases/<int:case_id>/urgency/', api_views.urgency_validation_api, name='urgency_validation_api'),
    ...
    path('api/cases/<int:case_id>/placement/', api_views.case_placement_detail_api, name='case_placement_detail_api'),
    ...
    path('casussen/<int:pk>/provider-evaluatie/', views.case_provider_evaluation_view, name='case_provider_evaluation'),
    path('casussen/<int:pk>/provider-evaluatie/action/', views.case_provider_evaluation_action, name='case_provider_evaluation_action'),
    path('casussen/<int:pk>/info-aanvraag/', views.case_info_request_view, name='case_info_request'),
    path('casussen/<int:pk>/info-aanvraag/action/', views.case_info_request_action, name='case_info_request_action'),

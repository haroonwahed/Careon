  ...
  return (
    ...
    >
      ...
      <ResponsiveContainer width="100%" height={300}>
        ...
        >
          <defs>
            <linearGradient id={`colorSales-${uniqueId}`} x1="0" y1="0" x2="0" y2="1">
              <stop
                offset="5%"
            ...
            <linearGradient id={`colorPurchases-${uniqueId}`} x1="0" y1="0" x2="0" y2="1">
              <stop
                offset="5%"
          ...
          <Area
            ...
            strokeWidth={2}
            fill={`url(#colorPurchases-${uniqueId})`}
            name="purchases"
          />
        </AreaChart>
      </ResponsiveContainer>

                ...
                return (
                  <button
                    ...
                    className={`
                      ...
                      ${isActive
                        ? "bg-primary/10 text-primary shadow-sm shadow-primary/20 border border-primary/20"
                    ...
                    {collapsed && (
                      ...
                      ">
                        ...
                        {item.badge !== undefined && (
                          <span className="ml-2 px-2 py-0.5 rounded-full text-xs font-bold bg-red-500/10 text-red-400">
                            {item.badge}
                          </span>
                        )}
                      </div>
